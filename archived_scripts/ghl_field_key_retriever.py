...
class GoHighLevelFieldUpdater:
    ...
    def update_csv_with_field_keys(self, csv_file_path: str, output_path: Optional[str] = None):
        """Update the CSV file with actual GHL field keys.
        
        This method safely converts CSV row values—replacing any None (or NaN) values with empty strings—to ensure all values are of type str.
        """
